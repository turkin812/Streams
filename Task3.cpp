...
// Task3.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask3App, CWinApp)
...
// Единственный объект CTask3App

CTask3App theApp;


// инициализация CTask3App

BOOL CTask3App::InitInstance()
{
